"""
Dividends Gold load stub.

Planned flow:
- Read curated dividends Silver records.
- Apply final conformance checks.
- Publish Gold-ready dividends dataset for serving/marts.
"""
...
def read_silver_records(run_id: str) -> None:
    """TODO: Read dividends Silver records for this run."""
